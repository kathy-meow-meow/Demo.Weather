package sg.edu.rp.c346.id22026882.demoweather;
    ...
    protected void onResume() {
        ...
        client.get("https://api.data.gov.sg/v1/environment/2-hour-weather-forecast", new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                ArrayAdapter<Weather> weatherAdapter = new ArrayAdapter<>(MainActivity.this, android.R.layout.simple_list_item_1, alWeather);
